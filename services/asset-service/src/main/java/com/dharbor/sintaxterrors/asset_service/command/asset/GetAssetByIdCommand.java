...
public class GetAssetByIdCommand
        extends SafeAbstractCommand<Long, AssetResponse>
    ...
    public void preExecute() {
        log.info("GetAssetByIdCommand - PreExecute");
    ...
    @Override
    public void execute() {
        log.info("GetAssetByIdCommand - Execute");
        this.output = assetService.getAssetResponseById(this.input);
    }

    @Override
    public void postExecute() {
        log.info("GetAssetByIdCommand - PostExecute");
